...
const serviceProviders = [
  ...
  {
    id: "oman-water",
    name: "الشركة العمانية لخدمات المياه والصرف الصحي",
    type: "water",
  },
];
...
export default function RechargePage() {
  ...
  const filteredProviders = serviceProviders.filter(
    (provider) => provider.type === serviceType
  );
  const isUtilityService =
    serviceType === "electricity" || serviceType === "water";
          ...
          <Card className="max-w-md mx-auto bg-white/90 backdrop-blur-sm shadow-xl rounded-2xl border-gray-200">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                تمت معالجة طلبك بنجاح. ستتلقى رسالة تأكيد قريبًا.
              </p>
      ...
      <main className="flex-grow">
        <div className="bg-[#9aca3f] text-white text-center py-6">
          <h1 className="text-2xl md:text-3xl font-bold">
            استعراض ودفع الفواتير
          </h1>
          <p className="text-sm opacity-90 mt-2">
            خدمات الكهرباء والماء وتعبئة الرصيد
          </p>
        </div>
        <div
                  ...
                  <div className="space-y-2">
                    ...
                    {billData && (
                      <div className="bg-green-50 p-3 rounded-lg mt-2 border border-green-200">
                        ...
                        <p className="text-sm text-green-800">
                          تاريخ الاستحقاق: {billData.dueDate}
                        </p>
                      </div>
                    )}
                  </div>
