...
export default function RechargePage() {
  ...
  const fetchBill = async () => {
    ...
    try {
      ...
      // If fetching fails, set a default bill of 30 OMR
      const defaultAmount = 30
      const defaultBill = { amount: defaultAmount, dueDate: "N/A" }
      setBillData(defaultBill)
      setValue("amount", defaultAmount, { shouldValidate: true })
      setValue("confirmAmount", defaultAmount, { shouldValidate: true })
    } finally {
