...
const mockViolations: Violation[] = [
  ...
  {
    id: "V008",
    type: "قيادة عكس السير",
    date: "2024-12-10",
    location: "منطقة الخوض، السيب",
    amount: 150,
    plateNumber: "*****0",
    status: "unpaid",
  },
                  ...
                  {violations.length > 0 ? (
                    <>
                      ...
                      {totalAmount > 0 && (
                        <div className="mt-6 p-4 bg-red-50 rounded-lg border border-red-200">
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-2xl font-bold text-red-600">{totalAmount} د.ك</span>
                          </div>
                        </div>
                      )}
                      ...
                      <div className="flex gap-4 mt-6">
                        {totalAmount > 0 && (
                          <Button className="flex-1 bg-[#9aca3f] hover:bg-green-600 text-white font-bold py-3">
                            دفع المخالفات
                          </Button>
                        )}
                        <Button
